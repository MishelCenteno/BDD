...
TENDENCIA = ['#BRITVIDANNEMARIE','#BRITVIDEDSHEERAN','#BRITs2018','#BRITs',
'#BritAwards','#BRITAwards','@AnneMarieIAm','@edsheeran',
'#Brits','#Brits','@BRITs','@BRITs']
...
try:
    ...
    db = server.create('premiosmusic')
except:
    #Caso contrario solo conectarse a la base existente
    db = server['premiosmusic']
...
twitterStream.filter(track=TENDENCIA)
#twitterStream.filter(languages=['es'],track=["quito","ecuador"], async=True)
